...
class HodMeatRegistrationListController extends Controller
{
    ...
    public function MeatRegistrationList(request $request, $status)
    {
        ...
        return view('hod.meat_registration.grid', compact('meat_registration_list', 'status','meattype_mst','unit_Meat_Type'));
    }
...
// dd($commaSeparatedMeatNames);


        return view('hod.meat_registration.view', compact('meat_registration_view','unit_Meat_Type','commaSeparatedMeatNames'));
    }
    ...
    public function FinalApproveView(request $request, $id, $status)
     {
        ...
        return view('hod.admin_approve_list.view', compact('meat_registration_view','unit_Meat_Type','commaSeparatedMeatNames'));
     }
