...
class HodMeatTransportRenewalListController extends Controller
{
     ...
     public function MeatTransportRenewalView(request $request, $id, $status)
    {
        ...
        return view('hod.meat_transport_renewal.view', compact('meat_transport_view','commaSeparatedMeatNames','unit_Meat_Type'));
    }
    ...
    public function FinalApproveRenewalView(request $request, $id, $status)
    {
        ...
        return view('hod.final_approve_meat_transport_renewal_list.view', compact('meat_transport_view','unit_Meat_Type','commaSeparatedMeatNames'));
    }
