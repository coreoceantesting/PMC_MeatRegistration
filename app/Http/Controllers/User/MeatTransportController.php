...
class MeatTransportController extends Controller
{
     ...
     public function create()
    {
        ...
        return view('user.meat_transport.meat_transport_registration', compact('meattype_mst','unit_Meat_Type'));
    }
     ...
     public function User_vehicalForm_View(Request $request, $application_id, $user_type)
    {
        ...
        if($user_type == 'Transport_Registration')
        {
            ...
            // return $data;
             ...
             return view('user.meat_transport.user_transport_form_view', compact('data', 'user_type','meattype_mst','unit_Meat_Type'));
        }
...
// dd($commaSeparatedMeatNames);
        return view('user.meat_transport.view', compact('meat_transport_view','meattype_mst','unit_Meat_Type','commaSeparatedMeatNames'));
    }
