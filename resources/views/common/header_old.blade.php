        ...
        <aside id="leftsidebar" class="sidebar" >
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <!--    </ul>-->
                    <!--</li>-->
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Meat Application</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/meat_registration_list', 0 ) }}">Pending Meat Application</a></li>
                            <li><a href="{{ url('/meat_registration_list', 1 ) }}">Approved Meat Application</a></li>
                            <li><a href="{{ url('/meat_registration_list', 2 ) }}">Rejected Meat Application</a></li>
                        </ul>
                    </li>

                     <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Meat Renewal Application</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/meat_renewal_list', 0 ) }}">Pending Meat Renewal Application</a></li>
                            <li><a href="{{ url('/meat_renewal_list', 1 ) }}">Approved Meat Renewal Application</a></li>
                            <li><a href="{{ url('/meat_renewal_list', 2 ) }}">Rejected Meat Renewal Application</a></li>
                        </ul>
                    </li>
