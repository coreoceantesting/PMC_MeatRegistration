        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Meat Registration Report</h2>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <!--</div>-->
                        <div class="body p-3">
                            <form method="post" action="{{ url('/search_report_meat_list') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <strong style="text-transform: capitalize;"> Meat Application List</strong>
                            </h2>
                        </div>
                        <div class="body">
                             <!--<div class="pull-right" style="float: right;">-->
                             <!--    <button class="btn btn-primary" onclick="exportTableToExcel('tblData', 'meat-application-data')">Export </button>-->
                                        ...
                                        @if(!empty($meat_search_registration_list))
                                            ...
                                            ?>
                								 ...
                								 <td>{{ date('d-m-Y', strtotime($value->inserted_dt)) }}</td>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/meat_report_view_hod', $value->id ) }}"  class="btn btn-primary waves-effect m-r-20">
                                                            View
                                                        </a>
                                                    </td>
