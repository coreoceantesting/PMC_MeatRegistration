            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <!--</div>-->
                        <div class="body p-3">
                            <form method="post" action="{{ url('/search_vehicle_report_list') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            @foreach ($meat_search_vehical_list as $key => $value)
                                                <tr>
                								 ...
                								 <td>{{ date('d-m-Y', strtotime($value->inserted_dt)) }}</td>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/meat_transport_report_view', $value->id ) }}"  class="btn btn-primary waves-effect m-r-20">
                                                            View
                                                        </a>
                                                    </td>
                								</tr>
