            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-1 text-start">
                                    <p>Pursuant to the bye-law of the Panvel Municipal Corporation relating to markets, private markets and slaughterhouses made under sub-sections (26) (27) (28) (29) and (48) of sections 331 and 458 of the Maharashtra Municipal Corporation Act, 1949, and section 335 and Sale of chicken/mutton/fish/buffalo meat to persons and places specified under 382.</p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        {{ (!empty($meat_renewal_pdf->re_final_approve_date) ? date("d/m/Y", strtotime($meat_renewal_pdf->re_final_approve_date)) : NULL) }}
                                    </p>
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                     <p class="mb-0">
                                        <strong>License Valid Date From . {{ (!empty($meat_renewal_pdf->approve_date_of_license_obtain) ? date("d/m/Y", strtotime($meat_renewal_pdf->approve_date_of_license_obtain)) : NULL) }} &nbsp;To &nbsp;{{ date("d/m/Y", strtotime($fiscalYear)) }}</strong>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3"> 
                                <div class="col-md-12 col-sm-12 text-right">
                                    <p class="mb-0">
                                         <strong>
                                            <img src="{{url('/')}}/PMC_Meat_Registration/re_hod_sign/{{ $meat_renewal_pdf->re_hod_sign }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:100px;">
                                       </strong> <br>
                    ...
                    <div class="submit-section text-right pt-5" >
					    <a href='{{  url("/final_meat_renewal_list/{$meat_renewal_pdf->re_final_approve}") }}' class="btn btn-danger btn-lg text-light" >Cancel</a>
