                ...
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            @if ($status == 0)
                                Pending Meat Renewal Application
                            @elseif ($status == 1)
                                Approve Meat Renewal Application
                            @elseif ($status == 2)
                                Reject Meat Renewal Application
                            @endif
                        </li>
                    </ul>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                @if ($status == 0)
                                    <strong style="text-transform: capitalize;">Pending Meat Renewal  Application</strong>
                                @elseif ($status == 1)
                                    <strong style="text-transform: capitalize;">Approve Meat Renewal Application</strong>
                                @elseif ($status == 2)
                                    <strong style="text-transform: capitalize;">Reject Meat Renewal Application</strong>
                                @endif
                                    ...
                                    <tbody>
                                        @foreach ($meat_renewal_list as $key => $value)
                                            <tr>
                								...
                								@endif
            									<td>
                                                    <a href='{{ url("/final_meat_renewal_view/{$value->id}/{$value->re_final_approve}") }}' class="btn btn-info btn-sm text-light">
                                                        <i class="zmdi zmdi-eye"></i>
                                                    </a>
                                                </td>
                                                
                                                 <td> 
                                                <a href='{{ url("/final_meat_renewal_invoice/{$value->id}/{$value->re_final_approve}") }}'  class="btn btn-primary waves-effect m-r-20" >
                                                        Invoice
                                                    </a>
                                               </td>
                                               ...
                                               <?php if($value->re_final_approve == 1) { ?> 
                                                 ...
                                                 <td>
                                                    ...
                                                    <a href='{{ url("/generate_english_meat_renewal_pdf_by_hod/{$value->id}/{$value->re_final_approve}") }}'
                                                        class="btn btn-danger waves-effect waves-float btn-sm waves-green">
                                                        <i class="zmdi zmdi-file"></i> English
                                                    </a>
                                                    &nbsp;&nbsp;
                                                    <a href='{{ url("/generate_marathi_meat_renewal_pdf_by_hod/{$value->id}/{$value->re_final_approve}") }}'
                                                        class="btn btn-danger waves-effect waves-float btn-sm waves-green">
                                                ...
                                                <td>
                                                      ...
                                                      <a href='{{ url("/generate_affidavit_meat_renewal_pdf_by_hod/{$value->id}/{$value->re_final_approve}") }}'
