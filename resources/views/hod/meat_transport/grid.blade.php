                                    ...
                                    <tbody>
                                        @foreach ($meat_registration_list as $key => $value)
                                            <tr>
                								...
                								@endif
            									<td>
                                                    <a href='{{ url("/meat_transport_view_hod/{$value->id}/{$value->t_hod_status}") }}' class="btn btn-info btn-sm text-light">
                                                        <i class="zmdi zmdi-eye"></i>
                                                    </a>
                                                </td>
                                                 <td>
                                                    <!--   <?php if($value->t_hod_status == 1) { ?>-->
                                                    <!--<a href='{{ url("/generate_english_meat_transport_pdf/{$value->id}/{$value->status}") }}'-->
                                                    <!--    class="btn btn-danger waves-effect waves-float btn-sm waves-green">-->
                                                    <!--    <i class="zmdi zmdi-file"></i> English-->
                                                    <!--</a>-->
                                                    <!--&nbsp;&nbsp;-->
                                                    <!--<a href='{{ url("/generate_marathi_meat_transport_pdf/{$value->id}/{$value->status}") }}'-->
                                                    <!--    class="btn btn-danger waves-effect waves-float btn-sm waves-green">-->
