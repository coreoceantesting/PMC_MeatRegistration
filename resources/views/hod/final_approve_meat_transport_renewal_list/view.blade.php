        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Meat Transport Renewal Application</h2>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Meat Transport Renewal Application</li>
                    </ul>
                    ...
                    <div class="card">
                        <div class="body">
                           ...
                           <div class="form-group row">
                                          ...
                                          <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/driving_licence/{{ $meat_transport_view->driving_licence }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        <?php }
                                                                    ...
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/driving_licence/{{ $meat_transport_view->driving_licence }}" target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                            ...
                                            <?php } else { ?>
                                                 ...
                                                 <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/driving_licence/{{ $meat_transport_view->driving_licence_doc }}" target="_blank">
                                                    <div class="form-group">
                                                        <?php $document_path = $meat_transport_view->driving_licence_doc;
                                                           $filter_path =  explode(".",$document_path);
                                                           $size_of_array = count($filter_path);
                                                           $filter_ext = $filter_path[$size_of_array - 1];
                                                        ...
                                                        $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                                           {?>
                                                        <p class="mt-3 mb-0" id="image_div">
                                                            <img src="{{url('/')}}/PMC_vehicle_Registration/meat_file/driving_licence/{{ $meat_transport_view->driving_licence_doc }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:150px;">
                                                        </p>
                                                        <?php }
                                                                else{
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/driving_licence/{{ $meat_transport_view->driving_licence_doc }}" target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
                                          ...
                                          <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/vehicle_insurance_doc/{{ $meat_transport_view->vehicle_insurance_doc }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        <?php }
                                                                    ...
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/vehicle_insurance_doc/{{ $meat_transport_view->vehicle_insurance_doc }}" target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
                                            ...
                                            <?php } else { ?>
                                                 ...
                                                 <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/vehicle_insurance_doc/{{ $meat_transport_view->vehicle_insurance }}" target="_blank">
                                                    <div class="form-group">
                                                        <?php $document_path = $meat_transport_view->vehicle_insurance;
                                                           $filter_path =  explode(".",$document_path);
                                                           $size_of_array = count($filter_path);
                                                           $filter_ext = $filter_path[$size_of_array - 1];
                                                        ...
                                                        $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                                           {?>
                                                        <p class="mt-3 mb-0" id="image_div">
                                                            <img src="{{url('/')}}/PMC_vehicle_Registration/meat_file/vehicle_insurance_doc/{{ $meat_transport_view->vehicle_insurance }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:150px;">
                                                        </p>
                                                        <?php }
                                                                else{
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_vehicle_Registration/meat_file/vehicle_insurance_doc/{{ $meat_transport_view->vehicle_insurance }}" target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
                                          ...
                                          <a href="{{url('/')}}/PMC_Meat_Registration/meat_file/transport_renewal/old_licence/{{ $meat_transport_view->old_licence }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                                           {?>
                                                        <p class="mt-3 mb-0" id="image_div">
                                                            <img src="{{url('/')}}/PMC_Meat_Registration/meat_file/transport_renewal/old_licence/{{ $meat_transport_view->old_licence }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:150px;">
                                                        </p>
                                                        <?php }
                                                                else{
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_Meat_Registration/meat_file/transport_renewal/old_licence/{{ $meat_transport_view->old_licence }}" target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
                            ...
                            <?php if($meat_transport_view->tr_final_approve == 0){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/final_meat_transport_renewal_list/0') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                                    <!--<a href="{{ url('/reject_meat_renewal_transport',$meat_transport_view->id) }}"><button type="button" class="btn btn-primary">Reject</button></a>&nbsp;&nbsp;-->
                                                    <!--<a href="{{ url('/approve_meat_renewal_transport',$meat_transport_view->id) }}"><button  type="button" class="btn btn-success">Approve </button> </a>-->
                                        ...
                                        <?php } elseif($meat_transport_view->tr_final_approve == 1){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/final_meat_transport_renewal_list/1') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                                   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                                </div>
                                            </div>
                                        <?php } elseif($meat_transport_view->tr_final_approve == 2){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('final_meat_transport_renewal_list/2') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>
                                                </div>
                                            </div>
                                        <?php }?>
                ...
                <form method="POST" action="{{ url('approve_meat_renewal_transport', $meat_transport_view->id ) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3 col-md-3 p-2">
                            <input type="file" name="tr_hod_sign" id="tr_hod_sign" class="form-control @error('tr_hod_sign') is-invalid @enderror" value="{{ old('tr_hod_sign', $meat_transport_view->tr_hod_sign) }}" accept=".jpg, .jpeg, .png">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-md-3"></label>
                        <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                            <a href='{{ url("/final_meat_transport_renewal_view/{$meat_transport_view->id}/{$meat_transport_view->tr_final_approve}") }}' class="btn btn-danger btn-lg">Cancel</a>&nbsp;&nbsp;
...
<div class="modal fade" id="largeModal1" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('final_approve_meat_transport_renewal_by_hod', $meat_transport_view->id ) }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" class="form-control " id="mobile_number" name="mobile_number" value="{{ $meat_transport_view->mobile_number }}" >
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        <label class="col-sm-3"><strong>Upload HOD Signature / <br>( विभाग प्रमुख स्वाक्षरी अपलोड करा ) : <span style="color:red;">*</span> </strong></label>
                        <div class="col-sm-3 col-md-3 p-2">
                            <input type="file" name="tr_hod_sign" id="tr_hod_sign" class="form-control @error('tr_hod_sign') is-invalid @enderror" value="{{ old('tr_hod_sign') }}" accept=".jpg, .jpeg, .png">
                            <small class="text-secondary text-justify "> Note : The file should be less than 2MB .</small>
                            <br>
                            <small class="text-secondary text-justify "> Note : Only files in .jpg, .jpeg, .png format can be uploaded .</small>
                            <br>
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('final_reject_meat_transport_renewal_by_hod', $meat_transport_view->id ) }}" enctype="multipart/form-data">
                    @csrf
