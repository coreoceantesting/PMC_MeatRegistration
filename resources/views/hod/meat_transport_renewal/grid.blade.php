                                    ...
                                    <tbody>
                                        @foreach ($meat_renewal_list as $key => $value)
                                            <tr>
                								...
                								@endif
                                                <td>
                                                    <a href='{{ url("/meat_transport_renewal_view_hod/{$value->id}/{$value->tr_hod_status}") }}' class="btn btn-info btn-sm text-light">
                                              ...
                                              <!--      <a href='{{ url("/generate_english_meat_transport_renewal_pdf/{$value->id}/{$value->status}") }}'-->
                                              <!--          class="btn btn-danger waves-effect waves-float btn-sm waves-green">-->
                                              <!--          <i class="zmdi zmdi-file"></i> English-->
                                              <!--      </a>-->
                                              <!--      &nbsp;&nbsp;-->
                                              <!--      <a href='{{ url("/generate_marathi_meat_transport_renewal_pdf/{$value->id}/{$value->status}") }}'-->
                                              <!--          class="btn btn-danger waves-effect waves-float btn-sm waves-green">-->
