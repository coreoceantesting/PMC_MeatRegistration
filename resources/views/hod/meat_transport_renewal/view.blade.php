                    ...
                    <div class="card">
                        <div class="body">
                           ...
                           <div class="form-group row">
                            ...
                            <?php if($meat_transport_view->tr_hod_status == 0){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/meat_transport_renewal_list_hod/0') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                            ...
                                            <?php } ?>
                                               ...
                                               <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>&nbsp;&nbsp;-->
                                                     <a href="{{ url('/approve_meat_transport_renewal_by_hod',$meat_transport_view->id) }}"><button  type="button" class="btn btn-success">Approve </button> </a>
                                                    <!--<button type="button" class="btn btn-success waves-effect m-r-20" data-toggle="modal" data-target="#largeModal1">Approve</button>-->
                                                </div>
                                            </div>
                                        <?php } elseif($meat_transport_view->tr_hod_status == 1){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/meat_transport_renewal_list_hod/1') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                                   <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>-->
                                                    <?php if ($meat_transport_view->tr_final_approve != 1) { ?>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <?php } ?>
                                        ...
                                        <?php } elseif($meat_transport_view->tr_hod_status == 2){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('meat_transport_renewal_list_hod/2') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>
                                                </div>
                                            </div>
                                        <?php } elseif (isset($meat_transport_view->tr_final_approve) && $meat_transport_view->tr_final_approve == 1) { ?>
                                    <div class="form-group row mt-4">
                                        <label class="col-md-3"></label>
                                        <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                            <a href="{{ url('/meat_transport_renewal_list_hod/1') }}"><button type="button" class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('approve_meat_renewal_transport', $meat_transport_view->id ) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-md-3"></label>
                        <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                            <a href='{{ url("/meat_transport_renewal_view_hod/{$meat_transport_view->id}/{$meat_transport_view->tr_hod_status}") }}' class="btn btn-danger btn-lg">Cancel</a>&nbsp;&nbsp;
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('reject_meat_transport_renewal_by_hod', $meat_transport_view->id ) }}" enctype="multipart/form-data">
                    @csrf
