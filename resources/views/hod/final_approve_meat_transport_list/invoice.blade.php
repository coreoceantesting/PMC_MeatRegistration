        ...
        <div class="block-header" id="hide-print">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Meat Transport Application</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        <li class="breadcrumb-item active">Meat Transport Application</li>
                    </ul>
                            ...
                            <table border=0 cellpadding=0 cellspacing=0 width=1088 style='border-collapse:
                             ...
                             <col width=64 span=17 style='width:48pt'>
                              ...
                              <tr height=20 style='height:15.0pt'>
                                   ...
                                   <td></td>
                                   <td></td>
                                   <td colspan=6 style='mso-ignore:colspan'>Application no - {{$invoice->transport_license_no}}</td>
                                   <td></td>
                                   <td class=xl69>&nbsp;</td>
                                   <td></td>
                                   <td></td>
