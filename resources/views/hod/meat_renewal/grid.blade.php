                                    ...
                                    <tbody>
                                        @foreach ($meat_renewal_list as $key => $value)
                                            <tr>
                                                ...
                                                <?php if(($value->re_hod_status == 2) ){ ?>
                                                      
                                                  <td>{{ $value->reject_resion }}</td>    
                                                      <?php    } ?>
            									<td>
                                                    <a href='{{ url("/meat_renewal_view_hod/{$value->id}/{$value->re_hod_status}") }}' class="btn btn-info btn-sm text-light">
                                               ...
                                               <?php //if($value->status == 1) { ?> 
                                                ...
                                                <!--    <a href='{{ url("/generate_english_meat_renewal_pdf/{$value->id}/{$value->status}") }}'-->
                                                <!--        class="btn btn-danger waves-effect waves-float btn-sm waves-green">-->
                                                <!--        <i class="zmdi zmdi-file"></i> English-->
                                                <!--    </a>-->
                                                <!--    &nbsp;&nbsp;-->
                                                <!--    <a href='{{ url("/generate_marathi_meat_renewal_pdf/{$value->id}/{$value->status}") }}'-->
                                                <!--        class="btn btn-danger waves-effect waves-float btn-sm waves-green">-->
