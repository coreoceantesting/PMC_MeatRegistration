        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong style="text-transform: capitalize;">Ward Master List</strong></h2>
                        </div>
                        <div class="body">
                            <a class="btn btn-primary boxs-close" href="{{ route('ward_master.create') }}" role="button">
                                <strong><i class="zmdi zmdi-plus"></i>&nbsp;&nbsp;Add Ward</strong>
                            </a>
                                    ...
                                    <tbody>
                                        @foreach ($ward_mst as $key => $value)
                                            <tr>
            									...
            									<td>
                                                    <a href="{{ route('ward_master.edit', $value->id) }}"
                                                ...
                                                <td>
                                                    <form action="{{ route('ward_master.destroy', $value->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
