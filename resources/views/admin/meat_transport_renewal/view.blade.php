                    ...
                    <div class="card">
                        <div class="body">
                           ...
                           <div class="form-group row">
                            ...
                            <?php if($meat_transport_view->status == 0){ ?>
                                        ...
                                        <?php } elseif($meat_transport_view->status == 1){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/meat_transport_renewal_list/1') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                                   <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>-->
                                                    <?php if ($meat_transport_view->tr_final_approve != 1) { ?>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <?php } ?>
                                        ...
                                        <?php } elseif($meat_transport_view->status == 2){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('meat_transport_renewal_list/2') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>
                                                </div>
                                            </div>
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('approve_meat_renewal_transport', $meat_transport_view->id ) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-md-3"></label>
                        <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                            <a href='{{ url("/meat_transport_renewal_view/{$meat_transport_view->id}/{$meat_transport_view->status}") }}' class="btn btn-danger btn-lg">Cancel</a>&nbsp;&nbsp;
                            <button type="submit" class="btn btn-success btn-lg">Submit</button>
                        </div>
                    </div>
                </form>
