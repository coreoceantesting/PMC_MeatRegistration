                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                 ...
                                 <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    ...
                                    <p class="font-weight-bold">License Number : -  {{ $meat_registration_pdf->meat_pplication_no }} </p>
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    <h5><strong>Chicken/Mutton/Fish/Buffalo Meat Selling Business License </strong></h5>
