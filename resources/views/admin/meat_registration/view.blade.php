                        ...
                        <div class="body">
                                ...
                                <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4 p-2">
                                                @php
                                                    ...
                                                    @endphp
                                                <input type="text" class="form-control @error('unit') is-invalid @enderror" name="unit" id="meat_type" value="{{ $unit->unit_name ?? '' }}" readonly style="width: 100%; height: 38px;">
                            ...
                            <div id="div2" style="display: none;">   
                                ...
                                <div class="form-group row">
                                      ...
                                      <label class="col-sm-2"><strong>Upload Official Slaughterhouse Information e-certificate <br>( अधिकृत कत्तलखाण्याची माहिती ई संमातीपत्र अपलोड करा ) : </strong></label>
                                    <div class="col-sm-4 col-md-4 p-2">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2"><strong>Upload medical fitness certificate of workers issued by registered general practitioner
( कामगारांचे वैद्यकीय फिटनेस प्रमाणपत्र अपलोड करा नोंदणीकृत जनरल प्रॅक्टिशनरने जारी केले आहे ): <span style="color:red;">*</span></strong></label>
                                    <div class="col-sm-4 col-md-4 p-2">
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                          ...
                                          <a href="{{url('/')}}/PMC_Meat_Registration/meat_file/profile_photo/{{ $meat_registration_view->profile_photo }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        <?php } else{ ?> <p>No Document Found</p> <?php }?>
                                                    </div>
                                                </a>
                                    </div> 
                                </div>
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                        ...
                                        <?php if($meat_registration_view->status == 0){ ?>
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/meat_registration_list/0') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                        ...
                                        <?php } elseif($meat_registration_view->status == 1){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/meat_registration_list/1') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                                   <?php if ($meat_registration_view->final_approve != 1) { ?>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <?php } ?>
                                                    <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>-->
                                        ...
                                        <?php } elseif($meat_registration_view->status == 2){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('meat_registration_list/2') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>
                                                </div>
                                            </div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('reject_meat_registration', $meat_registration_view->id ) }}" enctype="multipart/form-data">
                    @csrf
