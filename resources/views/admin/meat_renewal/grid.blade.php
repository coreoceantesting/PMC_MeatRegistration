                                        ...
                                        @foreach ($meat_renewal_list as $key => $value)
                                            <tr>
                                               ...
                                               @if($value->status == 2)
            									...
            									<td>
                                                    <a href='{{ url("/meat_renewal_view/{$value->id}/{$value->status}") }}' class="btn btn-info btn-sm text-light">
                                                ...
                                                @if($value->status == 1)
                                                 <td>  
                                                    <a href='{{ url("/meat_renewal_invoice/{$value->id}/{$value->status}") }}'  class="btn btn-primary waves-effect m-r-20">
                                                        Invoice
                                                    </a>
                                                </td>
                                                @endif
