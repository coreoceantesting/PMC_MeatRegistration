                            ...
                            <?php if($meat_transport_view->status == 0){ ?>
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/meat_transport_list/0') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                        ...
                                        <?php } elseif($meat_transport_view->status == 1){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/meat_transport_list/1') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                                     <?php if ($meat_transport_view->t_final_approve != 1) { ?>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                            <?php } ?>
                                                    <!--<a href="{{ url('/reject_meat_transport',$meat_transport_view->id) }}"><button type="button" class="btn btn-primary">Reject</button></a>-->
                                        ...
                                        <?php } elseif($meat_transport_view->status == 2){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('meat_transport_list/2') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>
                                                </div>
                                            </div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('reject_meat_transport', $meat_transport_view->id ) }}" enctype="multipart/form-data">
                    @csrf
