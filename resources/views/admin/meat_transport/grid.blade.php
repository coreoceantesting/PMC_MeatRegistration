                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $value->per_day_capacity }}</td>
                                                 @if($value->status == 2)
                                                  ...
                                                  @endif 
            									<td>
                                                    <a href='{{ url("/meat_transport_view/{$value->id}/{$value->status}") }}' class="btn btn-info btn-sm text-light">
                                                 ...
                                                 @if(($status == 1))
                                                	<td>
                                                    <a href='{{ url("/meat_transport_invoice/{$value->id}/{$value->status}") }}' class="btn btn-primary waves-effect m-r-20">
                                                        Invoice
                                                    </a>
                                                </td>
                                                 @endif
