				    ...
				    <div class="col-12"  id="divToPrint">
                        <div class="body" style="padding:30px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                     <p class="font-weight-bold">License Number-  {{ $meat_renewal_pdf->trans_renwal_liceans_no }}</p>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    <h5><strong>Chicken/Mutton/Fish/Buffalo Meat Sale Business License </strong></h5>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-1 text-start">
                                    <p>Pursuant to the bye-law relating to markets, private markets and counters of the Panvel Municipal Corporation made under sub-sections (26) (27) (28) (29) and (48) of sections 331 and 458 of the Maharashtra Municipal Corporation Act, 1949, and the said Act Business license for sale of chicken/mutton/fish/buffalo meat is being issued to the person and place mentioned under 335 and 382.</p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        {{ $meat_renewal_pdf->applicant_address  }}
                                    </p>
                                </div>
                            </div>
                             ...
                             <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        {{ $meat_renewal_pdf->vehical_register_no  }}
                                    </p>
                                </div>
                            </div>
                              ...
                              <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        {{ $meat_renewal_pdf->transport_license_no  }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        {{ (!empty($meat_renewal_pdf->tr_final_approve_date) ? date("d/m/Y", strtotime($meat_renewal_pdf->tr_final_approve_date)) : NULL) }}
                                    </p>
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="row pt-3"> 
                                <div class="col-md-12 col-sm-12 text-right">
                                    <p class="mb-0">
                                        <strong>
                                            <img src="{{url('/')}}/PMC_Meat_Registration/tr_hod_sign/{{ $meat_renewal_pdf->tr_hod_sign }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:100px;">
                                       </strong> <br>
                                        @if(!empty($meat_renewal_pdf->tr_final_approve_by == Auth::id()))
