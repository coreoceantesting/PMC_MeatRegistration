        ...
        <div class="align-items-center">
            ...
            <div class="min-height-200px">
    			...
    			<div class="card-box mb-30" style="border: 1px solid #000000;">
    					<div class="pd-20">
    						<h4 class="text-blue h4">PMC MEAT Transport Application Renewal List</h4>
    					</div>
    					<div class="pb-20">
    							...
    							<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $value->business_address }}</td>
                                             ...
                                             <td style="display:flex;" class="no-export">
                                                 <a href="{{ url('/user/meat_transport_renewal/' . $value->id . '/0') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->business_address }}</td>
                                           ...
                                           <td style="display:flex;" class="no-export">
                                              <a href="{{ url('/user/meat_transport_renewal_form/' . $value->id . '/0') }}" class="btn btn-primary btn-sm">
                                                <i class="material-icons"><i class="micon dw dw-eye"></i></i>
                                                Renewal
                                            </a>
