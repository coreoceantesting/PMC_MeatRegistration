                                                    ...
                                                    <div class="col-12 p-4">
                                                        ...
                                                        <div class="form-group row mt-4">
                                                            ...
                                                            <div class="col-md-6 text-right">
                                                                <button type="button" class="btn btn-primary" data-toggle="tab" href="#pet_details" onclick="changetab(this, '.basic_information', '.pet_details')">
                                                                    Save and Next
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="profile-setting">
                                                    <div class="col-12 p-4">
                                                        ...
                                                        <div class="form-group row mt-4">
                                                            ...
                                                            <div class="col-md-6 text-left">
                                                                <button type="button" class="btn btn-danger" data-toggle="tab" href="#basic_information" onclick="changetab(this,'.pet_details' , '.basic_information')">
                                                                    Back
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 text-right">
                                                                <button type="button" class="btn btn-primary" data-toggle="tab" href="#other_document" onclick="changetab(this, '.pet_details', '.other_document')">
                                                                    Save and Next
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                {?>
                                                     ...
                                                     elseif($filter_ext == 'pdf'){
                                                         ?>
                                                                ...
                                                                <div class="col-sm-4 col-md-4 p-2">
                                                                    <input type="file" name="slaughter_letter_doc" id="slaughter_letter_doc" accept=".png, .jpg, .jpeg, .pdf" class="form-control @error('slaughter_letter_doc') is-invalid @enderror" value="{{ old('slaughter_letter_doc') }}" placeholder="Upload medical fitness certificate issued by Municipal hospital">
                                                                    <input type="hidden" name="old_slaughter_letter_doc" value="{{ $data->slaughter_letter_doc ?? '' }}">
                                                                    <small class="text-secondary text-justify "> Note : The file should be less than 10MB .</small>
                                                                    <br>
                                                                    <small class="text-secondary text-justify "> Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</small>
                                                    ...
                                                    elseif($filter_ext == 'pdf'){
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-4 col-md-4 p-2">
                                                                ...
                                                                <input type="file" name="old_licence" id="old_licence" accept=".png, .jpg, .jpeg, .pdf" class="form-control @error('old_licence') is-invalid @enderror" value="{{ !empty($data->old_licence) ? $data->old_licence : '' }}" placeholder="Upload applicant signature">
                                                        ...
                                                        <div class="form-group row mt-4">
                                                            ...
                                                            <div class="col-md-6" style="display: flex; justify-content: start;">
                                                                <button type="button" class="btn btn-danger" data-toggle="tab" href="#pet_details" onclick="changetab(this, '.other_document', '.pet_details')">
                                                                    Back
                                                                </button>
                                                            </div>
