                            ...
                            <label class="col-sm-2"><strong>Unit / (युनिट) :<span style="color:red;">*</span> </strong></label>
                                       ...
                                       <select class="form-control custom-select2 @error('unit') is-invalid @enderror" name="unit" id="meat_type" style="width: 100%; height: 38px;">
                                            ...
                                            @foreach ($unit_Meat_Type as $item)
                                                <option value="{{ $item->id }}" {{ (old('unit') ?? $meat_renewal_view->unit) == $item->id ? 'selected' : '' }}>
                                                    {{ $item->unit_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 p-2">
                                             ...
                                             <a href="{{url('/')}}/PMC_Meat_Registration/meat_file/gumaste_doc/{{ $meat_renewal_view->gumaste_doc }}" target="_blank">
                                                        <div class="form-group">
                                                            <?php $document_path = $meat_renewal_view->gumaste_doc;
                                                               $filter_path =  explode(".",$document_path);
                                                               $size_of_array = count($filter_path);
                                                               $filter_ext = $filter_path[$size_of_array - 1];
                                                            ...
                                                            $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                                               {?>
                                                            <p class="mt-3 mb-0" id="image_div">
                                                                <img src="{{url('/')}}/PMC_Meat_Registration/meat_file/gumaste_doc/{{ $meat_renewal_view->gumaste_doc }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:150px;">
                                                            </p>
                                                            <?php }
                                                                    elseif($filter_ext == 'pdf'){
                                                                        ?>
                                      ...
                                      <label class="col-sm-2"><strong>Upload Municipal Corporation Permission Letter <br> (महापालिकेचे परवानगी पत्र करा ) : <span style="color:red;">*</span></strong></label>
                                        <div class="col-sm-4 col-md-4 p-2">
                                             <a href="{{url('/')}}/PMC_Meat_Registration/meat_file/municipal_corpor_doc/{{ $meat_renewal_view->municipal_corpor_doc }}" target="_blank">
                                                        <div class="form-group">
                                                            ...
                                                            $filter_ext == 'JPG' || $filter_ext=='JPEG' || $filter_ext == 'PNG' || $filter_ext == 'GIF' )
                                                               {?>
                                                            <p class="mt-3 mb-0" id="image_div">
                                                                <img src="{{url('/')}}/PMC_Meat_Registration/meat_file/municipal_corpor_doc/{{ $meat_renewal_view->municipal_corpor_doc }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:150px;">
                                                            </p>
                                                            <?php }
                                                                    else{
                                                                        ?>
