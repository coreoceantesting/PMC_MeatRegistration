				    ...
				    <div class="col-12"  id="divToPrint">
                        <div class="body" style="padding:30px;">
                            ...
                            <div class="row pt-0">
                                ...
                                <!--</div>-->
                                 <div class="col-md-9   col-sm-9 ">
                                  वाचा  -  <br<p class="font-weight-bold" >१.महाराष्ट्र महानगरपालिका अधिनियम १९४९ चे कलाम ६९ (१)</p>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                 ...
                                 <div class="col-md-12 col-sm-12 pt-3 text-center">
                                    ...
                                    <h5><b>परवाना क्रमांक  : -  {{ $meat_registration_pdf->meat_pplication_no }} </b></h5>
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-4 text-center">
                                    <h4><strong>चिकन/मटण/मासे/म्हशीचे मांस विक्री व्यवसाय परवाना </strong></h4>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        <?php
                                            ...
                                            ?>
                                        <strong>व्यवसायाचा प्रकार - </strong>
                                        {{ $business_type  }}
                                    </p>
                                </div>
                            </div>
                              ...
                              <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        @endphp
                                        {{ $unitName ? $unitName->unit_name : 'Unit not found' }}
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                      ...
                                      <p class="mb-0">
                                        <strong>परवाना वैध दिनांक :-   </strong>
                                         दि . {{ (!empty($meat_registration_pdf->approve_date_of_license_obtain) ? date("d/m/Y", strtotime($meat_registration_pdf->approve_date_of_license_obtain)) : NULL) }} &nbsp;ते&nbsp;{{ date("d/m/Y", strtotime($fiscalYear)) }}
                                      </p>
