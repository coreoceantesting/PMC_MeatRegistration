               ...
               <div class="card">
                    <div class="body">
                         ...
                         <tr height=20 style='height:15.0pt'>
                              ...
                              <td></td>
                              <td></td>
                              <td colspan=6 style='mso-ignore:colspan'>Application no - {{$invoice->meat_pplication_no}}</td>
                              <td></td>
                              <td class=xl69>&nbsp;</td>
                              <td></td>
                              <td></td>
                         ...
                         <tr height=20 style='height:15.0pt'>
                              ...
                              मांस/चिकन/मटण नवीन नोंदणी शुल्क /मांस/चिकन/मटण पुनर्नोंदणी शुल्क जमा करणेबाबत.	
                              </td>
                              <td></td>
                              <td></td>
                              <td class=xl69>&nbsp;</td>
                         ...
                         <tr height=20 style='height:15.0pt'>
                              ...
                              <td colspan=15 style='mso-ignore:colspan;'>
                                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                   उपरोक्त संदर्भिय विषयान्वये, आपण मांस/चिकन/मटण नोंदणी / पुनर्नोंदणी   शुल्कासाठी सादर केलेल्या अर्जानुसार शुल्क / पुनर्नोंदणी
                                   <br>  @if($invoice->meat_type == 1) 
                                        १३०० रु अक्षरी (one thousand three hundred) 
                                        @elseif($invoice->meat_type == 2)
                                        १००० रु अक्षरी (one thousand)
                                        @elseif($invoice->meat_type == 3)
                                        ७५० रु अक्षरी (seven hundred fifty)
                                        @elseif($invoice->meat_type == 4) 
                                        १३०० रु अक्षरी (one thousand three hundred) 
                                        @elseif($invoice->meat_type == 5) 
                                        १३०० रु अक्षरी (one thousand three hundred) 
                                        @elseif($invoice->meat_type == 6) 
                                        २०० रु अक्षरी (two hundred)  
                                        @else
                                        0 रु अक्षरी   
                                        @endif&nbsp;
                                   इतक्या रकमेचा   Demand draft द्वारे हा लेखा विभाग, पनवेल 
                                   महानगरपालिका  यांचेकडे   
                              </td>
                              <td class=xl68>&nbsp;</td>
                              <td></td>
                              <td></td>
