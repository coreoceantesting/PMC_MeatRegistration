                        ...
                        <div class="col-sm-10 col-xs-12 d-flex flex-column align-items-center align-items-sm-start">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Meat License</li>
                                </ol>
                            </nav>
                        </div>
				    ...
				    <div class="col-12"  id="divToPrint">
                        <div class="body" style="padding:30px;">
                            ...
                            <div class="row pt-0">
                                ...
                                <!--   जा.क्र.पमपा / वै.आ.वि. &nbsp; &nbsp; &nbsp;   / पशुवैद्यकीय सेवा / प्र.क.  {{ $meat_registration_pdf->meat_pplication_no }} / {{ now()->year }}   -->
                                <!--</div>-->
                                 <div class="col-md-9   col-sm-9 ">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                 ...
                                 <div class="col-md-12 col-sm-12 pt-1 text-center">
                                    <!--<h5><strong>License Number  {{ $meat_registration_pdf->meat_pplication_no }}</strong></h5>-->
                                    <h5> <b> License Number : -  {{ $meat_registration_pdf->meat_pplication_no }} </b></h5>
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    <h4><strong>Chicken/Mutton/Fish/Buffalo Meat Selling Business License </strong></h4>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-1 text-start">
                                    <p>Pursuant to the bye-law relating to markets, private markets and counters of the Panvel Municipal Corporation made under sub-sections (26) (27) (28) (29) and (48) of sections 331 and 458 of the Maharashtra Municipal Corporation Act, 1949, and the said Act Business license for Selling of chicken/mutton/fish/buffalo meat is being issued to the person and place mentioned under 335 and 382.</p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3">                                
                                ...
                                <!--        {{ $meat_registration_pdf->meat_pplication_no }}-->
                                <!--    </p>-->
                                <!--</div>-->
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        <?php
                                                ...
                                                {
                                                    $business_type = 'Meat/Fish Shop ( मांस/मासे दुकान)';
                                                }
                                                if($meat_registration_pdf->business_type == 5)
                                                {
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        {{ $meat_registration_pdf->meat_name  }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        ...
                                        {{ (!empty($meat_registration_pdf->final_approve_date) ? date("d/m/Y", strtotime($meat_registration_pdf->final_approve_date)) : NULL) }}
                                    </p>
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <!--<p class="mb-0">-->
                                    <!--    <strong>License Valid Date From . {{ $meat_registration_pdf->approve_date_of_license_obtain}} To {{$newEndingDate}} </strong>-->
                                    <!--</p>-->
                                     <p class="mb-0">
                            ...
                            <div class="row pt-3"> 
                                <div class="col-md-12 col-sm-12 text-right">
                                    <p class="mb-0">
                                         <strong>
                                            <img src="{{url('/')}}/PMC_Meat_Registration/hod_sign/{{ $meat_registration_pdf->hod_sign }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:100px;">
                                       </strong> <br>
