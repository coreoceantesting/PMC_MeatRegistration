				    ...
				    <div class="col-12"  id="divToPrint">
                        <div class="body" style="padding:30px;">
                            ...
                            <div class="row pt-0">
                                ...
                                <!--   जा.क्र.पमपा / वै.आ.वि. &nbsp; &nbsp; &nbsp;   / पशुवैद्यकीय सेवा / प्र.क.  {{ $meat_transport_pdf->transport_license_no }} / {{ now()->year }}   -->
                                <!--</div>-->
                                 <div class="col-md-9   col-sm-9 ">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    ...
                                    <!--<p class="font-weight-bold">संदर्भ क्रमांक - {{ $meat_transport_pdf->mobile_number }}</p>-->
                                 <!--<p class="font-weight-bold">संदर्भ क्रमांक - </p>-->
                                </div>
                                 <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    <!--<h5><strong>License Number  {{ $meat_transport_pdf->transport_license_no }}</strong></h5>-->
                                    <p class="font-weight-bold">परवाना क्रमांक  : -  {{ $meat_transport_pdf->transport_license_no }} </p>
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    <h5><strong> मांस / मासे / पशुधन वाहतूक व्यवसाय परवाना </strong></h5>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-1 text-start">
                                    <!--<p>महाराष्ट्र महानगरपालिका  अधिनियम ,१९४९ चे  कलम ३३१ आणि ४५८  चे  पोटकलम  (२६) (२७) (२८) (२९) आणि (४८) अन्वये तयार करण्यात आलेली  पनवेल महानगरपालिकेच्या बाजार, खाजगी बाजार व कत्तलखाना   बाबतचची उपविधी अनुसरून , व उक्त कायद्यातील कलाम ३३५ व ३८२ अन्वेय नमूद व्यक्तीस व ठिकाणी  चिकन/मटण/मासे/म्हशीच्या मांसाच्या विक्री व्ययसाय परवाना देण्यात येत आहे </p>-->
                            ...
                            <div class="row pt-3">                                
                                ...
                                <!--        {{ $meat_transport_pdf->transport_license_no }}-->
                                <!--    </p>-->
                                <!--</div>-->
                            </div>
                            ...
                            <div class="row pt-3">                                
                             ...
                             <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        <strong>वाहन नोंदणी क्रमांक - </strong>
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        <strong>मांस व्यवसाय प्रति दिवस क्षमता(टन ) - </strong>
                           ...
                           <?php 
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        <strong>परवाना वैध तारीख </strong>{{ (!empty($meat_transport_pdf->approve_date_of_license_obtain) ? date("d/m/Y", strtotime($meat_transport_pdf->approve_date_of_license_obtain)) : NULL) }}<strong> पासून</strong>      {{ date("d/m/Y", strtotime($fiscalYear)) }}<strong>    पर्यंत     </strong>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3"> 
                                <div class="col-md-12 col-sm-12 text-right">
                                    <p class="mb-0">
                                         <strong>
                                            <img src="{{url('/')}}/PMC_Meat_Registration/t_hod_sign/{{ $meat_transport_pdf->t_hod_sign }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:100px;">
                                       </strong> <br>
