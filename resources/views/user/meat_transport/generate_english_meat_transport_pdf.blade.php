				    ...
				    <div class="col-12"  id="divToPrint">
                        <div class="body" style="padding:30px;">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                 ...
                                 <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    ...
                                    <p class="font-weight-bold">License Number : -  {{ $meat_transport_pdf->transport_license_no }} </p>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    <p class="mb-0">
                                        <strong>Meat business Per day capacity (In Ton) - </strong>
                          ...
                          <?php 
                            ...
                            <div class="row pt-3">                                
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    From  {{ (!empty($meat_transport_pdf->approve_date_of_license_obtain) ? date("d/m/Y", strtotime($meat_transport_pdf->approve_date_of_license_obtain)) : NULL) }} &nbsp;To &nbsp;{{ date("d/m/Y", strtotime($fiscalYear)) }}
