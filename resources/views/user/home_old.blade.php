                ...
                <div class="card-box">
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                @if($type == 'vehical_license')
                                    @if($serch_result == 'Pending')
                                        <tr>
                                            <td>Received</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->inserted_dt)) }}</td>
                                            <td>Your Application No :- {{ $get_details->transport_license_no }} Is not yet proceesed by PMC office.</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($serch_result == 'Approve')
                                        <tr>
                                            ...
                                            <td>Your Application No :- {{ $get_details->transport_license_no }} is approved by PMC Office. Please collect your certificate from PMC office.</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($serch_result == 'Reject')
                                        <tr>
                                            ...
                                            <td>Your Application No :- {{ $get_details->transport_license_no }} is reject by PMC Office.</td>
                                        </tr>
                                    @endif
                                @elseif($type == 'meat_license')
                                    @if($serch_result == 'Pending')
                                        <tr>
                                            <td>Received</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->inserted_dt)) }}</td>
                                            <td>Your Application No :- {{ $get_details->meat_pplication_no }} Is not yet proceesed by PMC office.</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($serch_result == 'Approve')
                                        <tr>
                                            <td>Approved</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->approve_date)) }}</td>
                                            <td>Your Application No :- {{ $get_details->meat_pplication_no }} is approved by PMC Office. Please collect your certificate from PMC office.</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($serch_result == 'Reject')
                                        <tr>
                                            <td>Rejected</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->reject_date)) }}</td>
                                            <td>Your Application No :- {{ $get_details->meat_pplication_no }} is reject by PMC Office.</td>
                                        </tr>
                                    @endif
                                     @elseif($type == 'meat_license')
                                    @if($serch_result == 'Pending')
                                    ...
                                    @endif
                                     ...
                                     @elseif($type == 'meat_renewal_license')
                                    @if($serch_result == 'Pending')
                                        <tr>
                                            <td>Received</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->inserted_dt)) }}</td>
                                    ...
                                    @endif
                                     ...
                                     @elseif($type == 'vehical_renewal_license')
                                    @if($serch_result == 'Pending')
                                        <tr>
                                            <td>Received</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->inserted_dt)) }}</td>
                                            <td>Your Application No :- {{ $get_details->trans_renwal_liceans_no }} Is not yet proceesed by PMC office.</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($serch_result == 'Approve')
                                        <tr>
                                            <td>Approved</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->approve_date)) }}</td>
                                            <td>Your Application No :- {{ $get_details->trans_renwal_liceans_no }} is approved by PMC Office. Please collect your certificate from PMC office.</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($serch_result == 'Reject')
                                        <tr>
                                            <td>Rejected</td>
                                            <td>{{ date('d-M-Y',strtotime($get_details->reject_date)) }}</td>
                                            <td>Your Application No :- {{ $get_details->trans_renwal_liceans_no }} is reject by PMC Office.</td>
                                        </tr>
                                    @endif
                                            ...
                                            <!--<cite title="Source Title"></cite>-->
                                              ...
                                              @if( $isAuthenticated )
                                                ...
                                                @if( !empty($isRenewable->is_expired) == 0 )
                                                    <span style="text-align:center;">
                                                        <a >
                                                            <h6 class="text-warning">Meat Renewal License by 31 ,  March 2024</h6>
                                                        </a>
                                                    </span>
                                        ...
                                        <div class="font-size-12 text-white mt-3 mb-0">
                                            ...
                                            @if( $isAuthenticated )
                                                ...
                                                @if( !empty($istransRenewable->is_expired) == 0 )
                                                    <span style="text-align:center;">
                                                        <a >
                                                            <h6 class="text-warning">Vehicle Renewal License by 31 ,  March 2024</h6>
                                                        </a>
                                                    </span>
